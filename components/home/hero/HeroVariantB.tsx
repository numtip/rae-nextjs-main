...
/** Variant B — Split layout: text left, motion video right */
export default function HeroVariantB({ locale }: { locale: Locale }) {
  const h = hero[locale];
  const base = withLocale(locale, "/");

  return (
    <section
      className="hero-section hero-split-section"
      id="hero"
    ...
    >
      <div className="hero-split-layout">
        ...
        <div className="hero-split-video" aria-hidden="true">
          <video
            autoPlay
            muted
            loop
            ...
            preload="metadata"
            className="hero-video-contained"
          >
            <source
